...
<section class="loginSec">
    ...
    <div class="logSecLeft">
        <div class="loginFrmBx">
            ...
            <div class="logFrmTxt mb-5">
                <p>ثبت رمز عبور جدید</p>
                <strong>برای حساب کاربری خود رمز عبور جدید تعیین کنید</strong>
            </div>
            <form class="loginForm" method="get" action="{{route('new.password')}}">
                @csrf
                <div class="frmInputBx mb-3">
                    <span class="icon-Group-2105"></span>
                    <div class="position-relative">
                        <label for="inpt03" class="transitionCls"
                        >رمز عبور خود را وارد کنید</label
                        >
                        <input type="password" name="password" id="inpt03" class="transitionCls"/>
                        <input type="hidden" name="mobile" value="{{$mobile}}" id="inpt03" class="transitionCls"/>
                    </div>
                </div>
                {!! session()->get('mobile') !!}
                @error('password')
                ...
                <div class="frmInputBx mb-3">
                    ...
                    <div class="position-relative">
                        ...
                        <input type="password" name="password_confirmation" id="inpt04" class="transitionCls"/>
                    </div>
                </div>
