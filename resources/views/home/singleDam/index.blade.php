                        ...
                        <div class="prdctPgSldr">
                            ...
                            >
                                <div class="shopTopLnks">
                                    @if(auth()->user())
                                        <buy-dam :user="{{auth()->user()}}" :dam="{{$damData}}" :text="true"
                                                 :arrow="true" type="normal"></buy-dam>
                                    @else
                                        <buy-dam user="" :dam="{{$damData}}" :text="true"
                                                 :arrow="true" type="normal"></buy-dam>
                                    @endif
                    ...
                    <div class="prdctSelrBx">
                        <div class="prdctSlrRght">
                            ...
                            <div class="prdctSlrUser">
                                <img src="{{$dam->user_image}}" alt="{{$dam->user_id}}"/>
                                <div>
                                    <strong>{{$dam->user_id}}</strong>
                                    <p>{{$dam->user_dam_count}} محصول</p>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="newCatSldr">
            <div class="swiper-container">
                <div class="swiper-wrapper">
                    ...
                    @endforeach
                    {{--                    <div class="swiper-slide transitionCls">--}}
                    {{--                        <a href="" class="newCatCard position-relative">--}}
                    {{--                            <div class="newCatImg">--}}
                    {{--                                <img src="{{asset('img/img04.jpg')}}" alt="img"/>--}}
                    {{--                            </div>--}}
                    {{--                            <div class="newCatBdy">--}}
                    {{--                                <h2>دام، گاو شیری کد 12</h2>--}}
                    {{--                                <ul>--}}
                    {{--                                    <li>--}}
                    {{--                                        <span>نژاد </span>--}}
                    {{--                                        <p>جرسی</p>--}}
