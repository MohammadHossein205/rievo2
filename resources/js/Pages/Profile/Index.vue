...
const form = ref({
    ...
    discount_id: userData.discount_id,
...
const updateUser = () => {
    ...
    axios.put(`/admin/profile/${userData.id}`, form.value).then(res => {
        if (res.data === 200) {
            swal.fire({
    ...
    <div class="bg-[#f8f8f8] w-full h-screen pr-[16rem] pt-[6rem] pl-[.5rem] sm:pr-2">
        ...
        <div class="bg-white rounded-lg mt-1 p-5">
            <div class="user-img w-48 m-auto relative mt-5">
                ...
                <div class="text-center ml-10 text-red-500 pr-1 pt-2" v-if="errorList.image">
                    {{ errorList.image[0] }}
                </div>
            ...
            <div class="mt-16 grid grid-cols-[auto_auto] justify-items-center gap-5 sm:grid-cols-1">
                ...
                <div class="w-[100%]">
                    <input type="text" placeholder="تلفن همراه را وارد کنید" v-model="form.mobile"
                           class="w-[100%] h-10 pr-2 rounded-lg border-none bg-slate-100 text-[.85rem]">
                ...
                <div class="w-[100%]">
                    <input type="text" placeholder="شماره تلفن را وارد کنید" v-model="form.homeNumber"
                           class="w-[100%] h-10 pr-2 rounded-lg border-none bg-slate-100 text-[.85rem]">
                ...
                <div class="w-[100%]">
                    <input type="email" placeholder="پست الکترونیک خود را وارد کنید" v-model="form.email"
                           class="w-[100%] h-10 pr-2 rounded-lg border-none bg-slate-100 text-[.85rem]">
                ...
                <div class="w-[100%]">
                    <textarea placeholder="نشانی را وارد کنید" v-model="form.address"
            ...
            <div class="grid grid-rows-2">
                <button class="bg-[#3661ec] p-3 text-white rounded-lg w-36 mt-5 hover:text-red-500"
                        @click.prevent="updateUser">
                    ویرایش
                </button>
                <button class="bg-[#25282f] p-3 text-white rounded-lg w-36 mt-5 hover:text-red-500"
                        @click="ClearData">
                    پاک کردن
                </button>
            </div>
