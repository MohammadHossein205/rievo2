...
return [
    ...
    */
    'attributes' => [
        ...
        "group_id" => "دسته بندی",
        "group_company_id" => "نژاد بندی",
        "weight" => "وزن",
        "color" => "رنگ",
        "ageYear" => "سال تولد",
        "ageMonth" => "ماه تولد",
        "milk_amount" => "مقدار شیر",
        "end_time" => "زمان پایان",
        "nationalCode" => "کد ملی",
        "homeNumber" => "شماره تلفن",
        "birthDate" => "تاریخ تولد",
        "role_id" => "مقام",

        "face_to_face" => "حضوری",
        "link_way" => "راه های ارتباطی",
        "telegram" => "تلگرام",
        ...
        "top_big_text" => "متن تایتل بالا",
        "top_small_text" => "متن زیر تایتل بالا",
        "top_big_description" => "نوشته تایتل بالا",
        "estelam_text" => "متن استعلام",
        "baner_one_image" => "بنر اول",
        "baner_two_image" => "بنر دوم",
        "more_information_title" => "تایتل بیشتر بدانیم",
        "more_information_text" => "متن تایتل بیشتر بدانیم",
        "baner_one_image_link" => "لینک بنر اول",
        "baner_two_image_link" => "لینک بنر دوم",

        "big_title" => "متن تایتل",
        "small_title" => "متن کوچک تایتل",
        "big_text" => "توضیح بزرگ تایتل",
